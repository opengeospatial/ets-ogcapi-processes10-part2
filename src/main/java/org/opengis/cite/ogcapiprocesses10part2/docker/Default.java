package org.opengis.cite.ogcapiprocesses10part2.docker;
...
import org.opengis.cite.ogcapiprocesses10part2.SuiteAttribute;
...
public class Default extends CommonFixture {
	...
	public void fetchOGCApplicationPackage() {
		try {
			// TODO: how to get the file path from the class? using getResourceAsStream?
			File file=new File("/root/te_base/scripts/ogcapi-processes-1.0-part2/1.0/testdata/ogcapppkg.json");
