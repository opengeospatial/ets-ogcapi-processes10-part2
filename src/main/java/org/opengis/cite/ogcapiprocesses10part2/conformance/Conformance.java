package org.opengis.cite.ogcapiprocesses10part2.conformance;

import static io.restassured.http.ContentType.JSON;
import static io.restassured.http.Method.GET;
import static org.opengis.cite.ogcapiprocesses10part2.SuiteAttribute.API_MODEL;
import static org.opengis.cite.ogcapiprocesses10part2.SuiteAttribute.IUT;
import static org.opengis.cite.ogcapiprocesses10part2.SuiteAttribute.REQUIREMENTCLASSES;
import static org.opengis.cite.ogcapiprocesses10part2.conformance.RequirementClass.DRU;
...
import org.opengis.cite.ogcapiprocesses10part2.CommonFixture;
import org.opengis.cite.ogcapiprocesses10part2.openapi3.TestPoint;
...
public class Conformance extends CommonFixture {
	...
	assertTrue( validateResponseAgainstSchema(Conformance.urlSchema,response.getBody().asString()),
        ...
        assertTrue( this.requirementClasses.contains( DRU ),
                    "Conformance class \"http://www.opengis.net/spec/ogcapi-processes-2/1.0/conf/deploy-replace-undeploy\" is not available from path "
                                                              + testPointUri );
    }
