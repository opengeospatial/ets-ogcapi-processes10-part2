...
import org.opengis.cite.ogcapiprocesses10part2.util.JsonUtils;
...
public class CommonFixture {
	...
	public void initCommonFixture(ITestContext testContext) {
		...
		if (useLocalSchema) {
			specURL = getClass().getResource("/org/opengis/cite/ogcapiprocesses10part2/openapi/api-processes10.yaml");
		}
		else {
			try {
	 ...
	 * @return a {@link org.opengis.cite.ogcapiprocesses10part2.CommonFixture.Input} object
	 */
	 ...
	 * @param schemaNode a {@link com.fasterxml.jackson.databind.JsonNode} object
	 * @param id a {@link java.lang.String} object
	 * @return a {@link org.opengis.cite.ogcapiprocesses10part2.CommonFixture.Output} object
	 */
