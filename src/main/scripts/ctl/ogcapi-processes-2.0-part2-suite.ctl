...
<ctl:package xmlns:ctl="http://www.occamlab.com/ctl"
             ...
             xmlns:tns="http://www.opengis.net/cite/ogcapi-processes-2.0"
             xmlns:saxon="http://saxon.sf.net/"
             xmlns:tec="java:com.occamlab.te.TECore"
             xmlns:tng="java:org.opengis.cite.ogcapiprocesses20part2.TestNGController">
    ...
    <ctl:code>
      <xsl:variable name="form-data">
        <ctl:form method="POST" width="800" height="600" xmlns="http://www.w3.org/1999/xhtml">
          ...
          <div style="background:#F0F8FF" bgcolor="#F0F8FF">
            ...
            <ul>
              <li>
                <a href="https://docs.ogc.org/DRAFTS/20-044.html" target="_blank">OGC API - Processes - Part 2: Deploy, Replace, Undeploy, draft</a>
              </li>
            </ul>
          ...
          <fieldset style="background:#ccffff">
            ...
            <p>
              <h4 style="margin-bottom: 0.5em">URL to a CWL application package</h4>
              <div>
                <label for="urlAppPkg">URL to a CWL application package</label>
                <input type="text" id="urlAppPkg" name="urlAppPkg" size="128" value="https://github.com/Terradue/ogc-eo-application-package-hands-on/releases/download/1.5.0/app-water-bodies-cloud-native.1.5.0.cwl" />
              </div>
            </p>
            <p>
      ...
      <xsl:variable name="test-run-props">
        <properties version="1.0">
          ...
          <entry key="urlapppkg">
              <xsl:value-of select="$form-data/values/value[@key='urlAppPkg']" />
          </entry>
          ...
          <entry key="applicationpackageurl">
              <xsl:value-of select="$form-data/values/value[@key='applicationPackageUrl']" />
          </entry>
        </properties>
      </xsl:variable>
